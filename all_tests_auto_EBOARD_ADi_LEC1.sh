...
# OS:        Linux
# DATE:      Jan-13-2022, 17:00:39
#
#====================================================================
# ===== General =====
# Test API : adiLibGetErrorString(EERROR Code, char* ErrorString, size_t Length);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Error_String_Message

# Test API : adiLibInit(EBOARD_TYPE BoardType);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section adiLibInit


# Test API : adiLibGetSystemInfo(SystemInfo* SysInfo);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SYS_Info
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section User_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HighCurrent_LED
...
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section LEC1_HCO3A_Brightness [ADiDLL][HCO3A][PWM][POC]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section GPO_LED
...
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section LEC1_DO_Brightness [ADiDLL][DO][Brightness]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Register_DI
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section GPO_LED_Drive
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section EEPROM_Auto
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section ExtI2C
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Ext_SPI_RDID_REMS
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Crypto
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Crypto_AES
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe --PORT_VAL 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HardMeter_BACC_SetPort
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HardMeter

# Test API : adiHardMeterDetectionPort(uint64_t* Status)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HardMeter_Detection_ByPort

# Test API : adiHardMeterDetectionPin(uint8_t BitId, bool* Status)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --HM_PIN_ID 0x0 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HardMeter_Detection_ByPin

# Test API : adiHardMeterDetectionPort(uint64_t* Status);
# Test API : adiHardMeterDetectionPin(uint8_t BitId, bool* Status);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section HardMeter_Detect [ADiDLL][HardMeter][Detect]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SecMeter
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SecMeter_New
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --sec-pattern 1,2,3,4,5,6,7 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SecMeter_BitPattern
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --sec-counter-num 3 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SecMeter_Cycle


# ===== PIC =====
# Test API : adiLibGetSystemInfo(SystemInfo* SysInfo);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_Firmware_Version
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --pic-time 2019/04/13/01/02/03 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_RTC
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_RTC_GETCLOCK
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_RTC

# Test API : adiRtcCalibrate(int8_t Value)
# Due to restrict of argument parser, use the format of "--RTC-CAL-VALUE=<value>" to pass possible negative value.
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --RTC-CAL-VALUE=13 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section RtcCalibrateManual
./idll-test.exe --RTC-CAL-VALUE=-13 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section RtcCalibrateManual
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_1Wire_IDs
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_1Wire_EEPROM_Same_Pattern_0xA5
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_1Wire_EEPROM_Random_Pattern
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_GetPICEvent_and_CheckPICBatteryVoltage
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_Intrusion_Auto [CALLBACK][PIC][UNITTEST]
#
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_EventQueueFull_Auto [CALLBACK][PIC][UNITTEST]
#
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_WDTimeout_Auto [CALLBACK][PIC][UNITTEST]
#
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_RtcAlarm_Auto [CALLBACK][PIC][UNITTEST]
#
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_BatWarn_Auto [CALLBACK][PIC][UNITTEST]
#
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section Callback_PIC_BatLow_Auto [CALLBACK][PIC][UNITTEST]

# Battery warning
# Test API : adiBatSetWarningVoltage(const Batteries* Voltages);
# Test API : adiBatGetWarningVoltage(Batteries* Voltages);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 "Scenario: adiBatSetWarningVoltage"

# Battery low
# Test API : adiBatSetLowVoltage(const Batteries* Voltages);
# Test API : adiBatGetLowVoltage(Batteries* Voltages);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 "Scenario: adiBatSetLowVoltage"
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_RTC_ALARM_auto [PIC][RTC][ALARM][UNITTEST][AUTO]
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_RTC_ALARM_CONF_auto [PIC][RTC][ALARM][UNITTEST][AUTO]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 "Scenario: adiWatchdogSetSystemRestart"

# ===== SRAM =====
# Test API : adiSramGetSize(uint32_t* Size);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_Capacity
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_Same_Pattern_0xA5

./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_Random_Pattern

./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_Performance
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_AutoVerify
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_BankCopy
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_BankCompare
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SRAM_CalculateCRC32
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --serial-port LEC1_COM1 --signal-mask 3 --signal-value 3 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section adiSerialSetSignal [ADiDLL][LEC1][RAWCOM][SIGNAL]
./idll-test.exe --serial-port LEC1_COM2 --signal-mask 1 --signal-value 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section adiSerialSetSignal [ADiDLL][LEC1][RAWCOM][SIGNAL]
...
#   --serial-port available values : LEC1_COM1, LEC1_COM2
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --serial-port LEC1_COM1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section adiSerialGetSignal [ADiDLL][LEC1][RAWCOM][SIGNAL]
./idll-test.exe --serial-port LEC1_COM2 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section adiSerialGetSignal [ADiDLL][LEC1][RAWCOM][SIGNAL]
...
# Test API : adiSerialGetSignal(SerialHandle Handle, uint8_t* UartSignal);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
./idll-test.exe --serial-port LEC1_COM1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section LEC1_RAWCOM_FULLFUNC_SIGNAL [ADiDLL][LEC1][RAWCOM][SIGNAL]
./idll-test.exe --serial-port LEC1_COM2 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section LEC1_RAWCOM_FULLFUNC_SIGNAL [ADiDLL][LEC1][RAWCOM][SIGNAL]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe --GPIO_PORT_VAL 0xF -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SA3X_4xGPIO_by_Port
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ./idll-test.exe --GPIO_PIN_ID 0x0 --GPIO_PIN_VAL true -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section SA3X_4xGPIO_by_Pin