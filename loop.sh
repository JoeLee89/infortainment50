...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Error_String_Message

# Test API : adiLibInit(EBOARD_TYPE BoardType);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section adiLibInit

# Test API : adiLibGetSystemInfo(SystemInfo* SysInfo);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SYS_Info
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section User_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section HighCurrent_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section GPO_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section GPO_LED_Drive
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section GPI_Button
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section GPI_User_DIP_SW
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section EEPROM_Auto
# Can assign which eeprom to test
#sudo sudo ./idll-test.exe --EMEM_TYPE EMEM_EEPROM1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section EEPROM_Auto
#sudo sudo ./idll-test.exe --EMEM_TYPE EMEM_EEPROM2 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section EEPROM_Auto
#sudo sudo ./idll-test.exe --EMEM_TYPE EMEM_EEPROM3 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section EEPROM_Auto
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section ExtI2C
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_SPI_RDID_REMS
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Crypto
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Crypto_SHA
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Crypto_AES


# ===== FPGA FW SHA256 verify =====
# Test API : adiLibGetFirmwareSHA256(char* Sha256String);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" "Scenario: adiLibGetFirmwareSHA256"
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section HardMeter
#sudo sudo ./idll-test.exe --PORT_VAL 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section HardMeter


# Test API : adiHardMeterDetectionPort(uint64_t* Status)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section HardMeter_Detection_ByPort


# Test API : adiHardMeterDetectionPin(uint8_t BitId, bool* Status)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --HM_PIN_ID 0x0 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section HardMeter_Detection_ByPin
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SecMeter
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SecMeter_New

# Test API : adiSecShowBitPattern(uint8_t* pattern, size_t patternSize);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SecMeter_BitPattern
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo sudo ./idll-test.exe --sec-counter-num 3 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SecMeter_Cycle


# ===== PIC =====
# Test API : adiLibGetSystemInfo(SystemInfo* SysInfo);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_Firmware_Version
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --pic-time 2019/04/13/01/02/03 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC_GETCLOCK
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_1Wire_IDs
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_1Wire_EEPROM_Same_Pattern_0xA5
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_1Wire_EEPROM_Random_Pattern
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_GetPICEvent_and_CheckPICBatteryVoltage
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_Intrusion_Auto [CALLBACK][PIC][UNITTEST]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_EventQueueFull_Auto [CALLBACK][PIC][UNITTEST]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_WDTimeout_Auto [CALLBACK][PIC][UNITTEST]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_RtcAlarm_Auto [CALLBACK][PIC][UNITTEST]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_BatWarn_Auto [CALLBACK][PIC][UNITTEST]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Callback_PIC_BatLow_Auto [CALLBACK][PIC][UNITTEST]

# RD Test
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" [AUTO][UNITTEST]

# RD Test
# Assign --pic-fw parameter to verify
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# sudo sudo ./idll-test.exe --pic-fw 110  -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_Firmware_Version
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC_ALARM_auto [PIC][RTC][ALARM][UNITTEST][AUTO]
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC_ALARM_CONF_auto [PIC][RTC][ALARM][UNITTEST][AUTO]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" "Scenario: adiWatchdogSetSystemRestart" -s
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SRAM_Capacity
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SRAM_Same_Pattern_0xA5
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SRAM_Random_Pattern
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SRAM_Performance
...
# Test API : adiSramGetBankInformation( uint32_t *Number, uint32_t *Size);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section ASYNC_SRAM
...
# Test API : adiSramGetBankInformation( uint32_t *Number, uint32_t *Size);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SYNC_SRAM
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --GPIO_PORT_VAL 0xF -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SA3X_4xGPIO_by_Port
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo sudo ./idll-test.exe --GPIO_PIN_ID 0x0 --GPIO_PIN_VAL true -- --EBOARD_TYPE EBOARD_ADi_"$board" --section SA3X_4xGPIO_by_Pin